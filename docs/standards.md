...
| STD-003 doc freshness | adopted | The release checklist requires docs reconciliation; PR #35 corrected the stale README version and repo-specific review-routing claims before this standards adoption merged. |
